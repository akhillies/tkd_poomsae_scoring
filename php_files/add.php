<?php
    ...
    $id = mysql_real_escape_string(array_key_exists('id', $_POST) ? $_POST['id'] : 0);
    $age = mysql_real_escape_string(array_key_exists('age', $_POST) ? $_POST['age'] : 0);
    $belt = mysql_real_escape_string(array_key_exists('belt', $_POST) ? $_POST['belt'] : "black");
    $division = mysql_real_escape_string(array_key_exists('division', $_POST) ? $_POST['division'] : 0);
    $round = mysql_real_escape_string(array_key_exists('round', $_POST) ? $_POST['round'] : 0);
    $gender = mysql_real_escape_string(array_key_exists('gender', $_POST) ? $_POST['gender'] : 0);
    $school = mysql_real_escape_string(array_key_exists('school', $_POST) ? $_POST['school'] : "unknown");
